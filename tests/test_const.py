...
const = _load("custom_components/eltrue_thessla_green_airpack_ha/const.py")


def test_domain():
    assert const.DOMAIN == "eltrue_thessla_green_airpack_ha"
...
def _load_sensor():
    ...
    const_spec = importlib.util.spec_from_file_location(
        "_airpack_const", os.path.join(ROOT, "custom_components/eltrue_thessla_green_airpack_ha/const.py")
    )
    const_mod = importlib.util.module_from_spec(const_spec)
    sys.modules["custom_components"] = types.ModuleType("custom_components")
    sys.modules["custom_components.eltrue_thessla_green_airpack_ha"] = types.ModuleType("custom_components.eltrue_thessla_green_airpack_ha")
    sys.modules["custom_components.eltrue_thessla_green_airpack_ha.const"] = const_mod
    sys.modules["custom_components.eltrue_thessla_green_airpack_ha.coordinator"] = types.SimpleNamespace(
    ...
    sensor_spec = importlib.util.spec_from_file_location(
        "custom_components.eltrue_thessla_green_airpack_ha.sensor",
        os.path.join(ROOT, "custom_components/eltrue_thessla_green_airpack_ha/sensor.py"),
        submodule_search_locations=[],
    )
    sensor_mod = importlib.util.module_from_spec(sensor_spec)
    sys.modules["custom_components.eltrue_thessla_green_airpack_ha.sensor"] = sensor_mod
